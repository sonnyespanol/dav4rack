...
module DAV4Rack
  ...
  class Resource
    ...
    def method_missing(*args)
      pc("Resource#method_missing", "", "red")
      result = nil
      orig = args.shift
      ...
      pc("Resource#method_missing result", result.to_s, "brown")
      result
    end

    # Returns if resource supports locking
    def supports_locking?
      pc("Resource#supports_locking", "", "red")
      false #true
    end
    ...
    def parent_exists?
      pc("Resource#parent_exists?", "", "red")
      parent.exist?
    end

    # Is the parent resource a collection?
    def parent_collection?
      pc("Resource#parent_collection?", "", "red")
      parent.collection?
    end
    ...
    def name
      pc("Resource#name", "", "red")
      File.basename(path)
    end

    # Name of the resource to be displayed to the client
    def display_name
      pc("Resource#display_name", "", "red")
      name
    end

    # Available properties
    def properties
      pc("Resource#properties", "", "red")
    ...
    def allows_redirect?
      pc("Resource#allows_redirect", "", "red")
      [
        %r{cyberduck}i,
        %r{konqueror}i
      ].any? do |regexp|
    ...
    def auth_credentials
      pc("Resource#auth_credentials", "", "red")
